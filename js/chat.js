...
const FORM_ENDPOINT='https://formsubmit.co/ajax/hello@mikaro.studio';
...
const INTENTS=[
 ...
 {k:['ai','artificial','llm','gpt','claude','model','machine','automat'],a:`Mikaro runs as a two-mind studio: one human owning taste, strategy and every decision — one AI partner writing production code at machine speed. Not AI-generated: AI-amplified. The AI Lab page shows exactly how.`,acts:[{h:'/ai-lab.html',l:'Visit the AI Lab'}]},
 ...
 {k:['time','long','timeline','fast','deadline','when','delivery'],a:`Fast, honestly. OptiClean went from one reference image to a ten-page live store with checkout in days, not months. A typical brand site lands in 1–2 weeks; commerce and app builds are scoped case by case.`,acts:[{q:'__lead',l:'Get an estimate'}]},
 ...
 {k:['who','about','team','studio','founder','mike'],a:`Mikaro is a one-person creative technology studio in Bangkok, plus an AI development partner. Small on headcount, unreasonable on detail — and everything shipped is live.`,acts:[{h:'/work.html',l:'Proof'}]},
