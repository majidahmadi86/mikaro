...
const TH_INTENTS=[
 ...
 {k:['ai','เอไอ','ปัญญาประดิษฐ์'],a:'Mikaro คือสตูดิโอขับเคลื่อนด้วย AI ทิศทางงานสร้างสรรค์ระดับซีเนียร์ ผสานพลังวิศวกรรม AI เต็มรูปแบบ ส่งมอบระบบมาตรฐานสากลในไม่กี่สัปดาห์ ไม่ใช่หลายเดือน',acts:[{h:'/th/ai-lab',l:'ชม AI Lab'}]},
