...
const FACTS=Object.freeze({
  shared:{
    ...
    trackRecord:'Live work includes: The Teak House (complete hotel booking system, teakhouse.mikaro.studio), PRAOW (clinic system, praow.mikaro.studio), Balzac Antiques (real client in Switzerland, balzacantiques.ch), Groupe Balzac (bilingual English and French corporate hub, balzacgroupe.com), Miomika (our own AI language app, miomika.com), OptiClean (real online store, opticlean.mikaro.studio).',
    process:{
