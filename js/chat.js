...
const TH_INTENTS=[
 ...
 {k:['ร้าน','ธุรกิจ','เสริมสวย','ร้านอาหาร','จองคิว','แพ็กเกจ','เดโม่'],a:'ถ้าคุณมีร้าน ร้านเสริมสวย ร้านอาหาร หรือคลินิก หน้า สำหรับธุรกิจ มีแพ็กเกจชัด ๆ พร้อมตัวช่วยสร้างแผน และขอเดโม่ฟรีได้เลย',acts:[{h:'/th/business',l:'สำหรับธุรกิจ'}]},
...
const INTENTS=[
 ...
 {k:['business','salon','restaurant','clinic','booking','package','wholesale','for business'],a:`Run a shop, salon, restaurant or clinic? The For business page has clear packages, an AI plan helper, and a free demo request.`,acts:[{h:'/business',l:'For business'}]},
